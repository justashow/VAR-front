...
import "./ticketOwnerController.css";
...
const FaqItem = ({
  ...
  return (
    <>
      ...
      {isOpen && <div className="AddAuctionText">{answer}</div>}
    </>
  );
};
//----------------------------------------------------------------
...
const TicketOwnerController = () => {
  ...
  const faqs = [
    {
      ...
      answer: (
        <div>
          <li>"만났어요" 버튼을 눌러 만남 시간을 정확히 측정해 주세요.</li>
  ...
  //----------------------------------------------------------------
  return (
    <div className="TicketControllerWrapper">
      <div>
        <div>
          <div className="FAQTitle"></div>
          {faqs.map((faq, index) => (
      ...
      <div className="TicketInfoWrapper">
        ...
        <div className="TicketInfoButtonContainer">
