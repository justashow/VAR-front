...
const PointChargeOption = () => {
  ...
  return (
    <div className="ChargePointContainer">
      <h1>포인트 충전하기</h1>
      <div className="ChargePointTermsContainer">
      ...
      <div className="ChargePointInputContainer">
        <div className="ChargePointInput">
          <input
            type="number"
        ...
        <div className="ChargePointButtonGroup">
          <button
            className="btn-basic"
